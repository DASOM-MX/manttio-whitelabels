 ...
 *
 *  The Worker exists to own the request path and serve `GET /__config`, not to
 *  render. Nothing is server-rendered today, which is what keeps the migration
 *  small: no feature area, PrimeNG, NGXS-storage or Dexie needs SSR-safety work,
 *  and no guard or initializer ever executes in a server runtime.
 *
