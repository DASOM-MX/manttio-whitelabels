...
/** Chakra-style filter popover — ported from superadmin. List-page filters
 *  collapse behind a trigger left of the page's primary action; URL query
 *  params stay the single load path. Project the `.field-group`s as
 *  content; overlay-bearing controls inside must NOT use `appendTo="body"`
 *  — their overlay has to live inside the popover DOM. */
@Component({
