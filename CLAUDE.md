...
| `superadmin/` | Angular 21.2 (standalone, zoneless) + NGXS 21 + PrimeNG 21 Aura + Tailwind 3.4, SSR with all routes CSR | Cloudflare Workers (`demo-superadmin-manttio-wl`) | **Active** — see `superadmin/CLAUDE.md` for conventions |
